          ...
          >
            {contactMethods.map((method, index) => (
              <motion.div
                ...
                className="bg-white rounded-xl p-4 sm:p-5 md:p-6 shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-1 flex flex-col"
              >
                ...
                <div className="text-sm sm:text-base text-primary-600 font-medium mb-1.5 sm:mb-2 font-roboto break-words whitespace-pre-line">
                  {method.value}
                </div>
